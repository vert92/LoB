...
namespace LeagueOfBalkan
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            var credentialUserName = "leagueofbalkan@hotmail.com";
            var sentFrom = "leagueofbalkan@hotmail.com";
            var pwd = "Leagueoflob123!";

            System.Net.Mail.SmtpClient client = new System.Net.Mail.SmtpClient("smtp.live.com");
            client.Port = 587;
